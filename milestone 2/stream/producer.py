...
SCHEMAS: Dict[str, Schema] = {
    ...
    "aerosparks.watch": Schema(schema_str=json.dumps({
        "type": "record",
        "name": "WatchEvent",
    ...
    "aerosparks.rate": Schema(schema_str=json.dumps({
        "type": "record",
        "name": "RateEvent",
        "namespace": "aerosparks",
        "fields": [
    ...
    "aerosparks.reco_requests": Schema(schema_str=json.dumps({
        "type":"record","name":"RecoRequest","namespace":"aerosparks",
        "fields":[
            {"name":"event","type":{"type":"enum","name":"EventTypeRecoReq","symbols":["reco_request"]}},
            {"name":"user_id","type":"long"},
            {"name":"k","type":"int"},
            {"name":"timestamp","type":"string"}
        ]
    ...
    "aerosparks.reco_responses": Schema(schema_str=json.dumps({
        "type":"record","name":"RecoResponse","namespace":"aerosparks",
        "fields":[
            {"name":"event","type":{"type":"enum","name":"EventTypeRecoResp","symbols":["reco_response"]}},
            {"name":"user_id","type":"long"},
