...
with open(os.path.join(REGISTRY, "uid2idx.pkl"), "wb") as f:
    pickle.dump(uid2idx, f)
with open(os.path.join(REGISTRY, "iid2idx.pkl"), "wb") as f:
...
def recommend_items_for_uid(u_external: int, k: int = 100) -> list[int]:
    ...
    try:
        ...
        recs = als.recommend(u, single_user_row, N=k, filter_already_liked_items=True)
...
ax.set_xlabel("The Bucket")
ax.set_ylabel("The NDCG@20")
plt.tight_layout()
plt.show()
